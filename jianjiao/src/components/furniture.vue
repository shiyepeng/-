	    ...
	    <!-- Add Pagination -->
  		...
  		<div class="banner-group-and-product-record" v-for="data in list">
	        ...
	        <div class="product-list">
	            <ul class="clearfix">
	                <li v-if="data.moduleContent.products.length < 7 " v-for="datachild in data.moduleContent.products">
	            ...
	            <div class="swiper-container a clearfix">
				    <div class="swiper-wrapper">
					      <div class="swiper-slide" v-if="data.moduleContent.products.length > 10" v-for="datas in data.moduleContent.products">
...
<script type="text/javascript">
	...
	export default{
		...
		mounted(){
			axios.get("/v2/page?pageId=1&tabId=10005&_=1539944636699").then(res=>{
